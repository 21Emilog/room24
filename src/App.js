        ...
        <div className="max-w-xl mx-auto space-y-3">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            ...
            <div className="flex flex-wrap gap-2">
              {/* Google */}
              <div className={`flex items-center gap-2 p-2 rounded-lg border ${hasGoogle ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'}`}>
              ...
              {/* Phone */}
              <div className={`flex items-center gap-2 p-2 rounded-lg border ${hasPhone ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'}`}>
              ...
              {/* Email */}
              <div className={`flex items-center gap-2 p-2 rounded-lg border ${hasPassword ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'}`}>
